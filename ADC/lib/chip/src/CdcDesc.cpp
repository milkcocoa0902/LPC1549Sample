...
#include "../inc/usbd/app_usbd_cfg.hpp"
 ...
 */
ALIGNED(4) const uint8_t UsbDeviceDescriptor[] = {
 ...
 */
ALIGNED(4) uint8_t UsbFsConfigDescriptor[] = {
	/* Configuration 1 */
 ...
 */
ALIGNED(4) const uint8_t UsbStringDescriptor[] = {
