...
extern const uint8_t UsbDeviceDescriptor[];
extern uint8_t UsbFsConfigDescriptor[];
extern const uint8_t UsbStringDescriptor[];
extern const uint8_t UsbDeviceQualifier[];
